...
public class MainContributorFragment extends Fragment {
    ...
    private List<RecyclerContributorBean> loadData() {
        data = new ArrayList<>();
        data.add(new RecyclerContributorBean(R.drawable.and,"and","任何胆敢为爱付出灵魂的人，都拥有改变世界的力量。",0xff66bb6a));
        data.add(new RecyclerContributorBean(R.drawable.lollipop,"Lollipop","你必须很努力，才能看上去毫不费力。",0xffff9100));
        data.add(new RecyclerContributorBean(R.drawable.night_farmer,"Night Farmer","我就是我，不一样的烟火！",0xff90a4ae));
        return data;
    }
